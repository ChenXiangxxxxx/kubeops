          ...
          <a-table
              ...
              <template #bodyCell="{ column, record }">
                  ...
                  <template v-if="column.key === 'action'">
                      <c-button style="margin-bottom:5px;" class="statefulSet-button" type="primary" icon="form-outlined" @click="getStatefulSetDetail(record)">YML</c-button>
